...
@allure.suite('Update User Operations')
@allure.title('Patch Update Existing User')
@allure.description('Test to verify that patch updating an existing user returns a 200 status code and the correct response body.')
